...
Route::get('/profil_penulis',[PenulisController::class, 'profil'])->name('profil.penulis');
Route::patch('/profil/update',[PenulisController::class, 'updateProfil'])->name('profil.update');

Route::get('/postingan_create',[PostinganController::class, 'create'])->name('postingan.create');
...
// Route::group(['middleware' => ['auth','checkRole:penulis'],'prefix' => 'penulis'],function(){
//     Route::get('/',[App\Http\Controllers\PenulisController::class, 'index'])->name('penulis.index');
//     Route::get('/postingan',[App\Http\Controllers\PenulisController::class, 'postingan'])->name('penulis.postingan');
//     Route::get('/tambah_postingan',[App\Http\Controllers\PenulisController::class, 'create'])->name('penulis.create');
// });
