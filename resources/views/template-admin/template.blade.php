        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="index.html" aria-expanded="false"><i class="mdi mdi-gauge" active></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{route('kategori')}}" aria-expanded="false"><i class="mdi mdi-cloud-check"></i><span class="hide-menu">Daftar Kategori</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{route('subKategori')}}" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Daftar Sub Kategori</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{route('postingan')}}" aria-expanded="false"><i class="mdi mdi-emoticon"></i><span class="hide-menu">Postingan</span></a>
                        </li>
                    </ul>
            ...
            <div class="sidebar-footer">
                ...
                <!-- item--><a href="{{ route('logout') }}" onclick="event.preventDefault();
