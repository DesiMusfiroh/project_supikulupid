      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{(request()->is('penulis/postingan')) ? 'active' : ''}}">
            ...
            <ul class="dropdown-menu">
              <li><a class="nav-link" href="{{route('tambahPostingan')}}">Buat Postingan</a></li>
              <li><a class="nav-link" href="{{route('adminPostingan')}}">Riwayat Postingan Admin</a></li>
            </ul>
          </li>
          <li class="{{(request()->is('admin/data_tulisan')) ? 'active' : ''}}"><a class="nav-link" href="/admin/data_tulisan"><i class="fas fa-pencil-ruler"></i> <span>Postingan Penulis</span></a></li>
