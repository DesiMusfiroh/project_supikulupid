...
<div class="card p-4">
    <div class="card-header">
        ...
        <!-- <form action="#"> -->
            ...
            <!-- <button type="submit" class="d-block mr-0 ml-auto btn-success " href = "#"><i class="fa fa-plus"></i> Tambah</button> -->
        <!-- </form> -->
        <a href="{{route('tambahPostingan')}}" class="btn btn-success" style="float:right"> <i class="fa fa-plus"></i> Tambah</a>
    </div>
