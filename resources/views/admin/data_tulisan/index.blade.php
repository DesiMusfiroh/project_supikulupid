                    ...
                    <tr>
                        ...
                        <td class="text-right">
                           @if($value->status == 'processed')
                            <a href="{{route('publishPostingan', $value->id_postingan)}}" >
                                 <button class="btn btn-success btn-action"> <i class="fa fa-check" aria-hidden="true"></i></button>
                            </a>
                            
                            <a href="{{route('rejectPostingan', $value->id_postingan)}}" >
                                 <button class="btn btn-danger btn-action"> <i class="fa fa-times" aria-hidden="true"></i></button>
                            </a>
                            @endif
